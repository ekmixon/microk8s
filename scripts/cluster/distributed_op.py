        ...
        try:
            ...
            for node_info in info["items"]:
                ...
                if res.status_code != 200:
                    print(
                        f'Failed to perform a {remote_op["action_str"]} on node {node_ep} {res.status_code}'
                    )
        ...
        with open(callback_tokens_file, "r+") as fp:
            for line in fp:
                ...
                try:
                    ...
                    if res.status_code != 200:
                        print(f'Failed to perform a {remote_op["action_str"]} on node {node_ep}')
